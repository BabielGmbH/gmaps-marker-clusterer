export default function() {
	 ...
	 * @author Herbert Braun <herbert.braun@ibm.com>
	 * @fileoverview
	...
	function defaultClusterOnAdd(clusterIcon) {
		...
		if (clusterIcon.visible_) {
			...
			clusterIcon.div_.setAttribute('tabindex', '0');
		...
		google.maps.event.addDomListener(clusterIcon.div_, 'keyup', function(event) {
